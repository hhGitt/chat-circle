/*
 ...
 Source Schema         : hh_server

 Target Server Type    : MySQL
 Target Server Version : 80023 (8.0.23)
 File Encoding         : 65001

 Date: 18/05/2023 10:30:11
*/
...
CREATE TABLE `role_permission`  (
  ...
  `permission_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '权限id',
...
CREATE TABLE `t_chat_msg`  (
  `id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `send_user_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '发送信息用户id',
  `accept_user_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '接收信息用户id',
  `msg` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '发送的信息',
  `create_time` timestamp NOT NULL COMMENT '信息发送时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '聊天信息表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_chat_msg
-- ----------------------------
INSERT INTO `t_chat_msg` VALUES ('148823437727498240', '1', '148819630205435904', 'test1', '2023-05-16 16:11:13');
INSERT INTO `t_chat_msg` VALUES ('148823452453699584', '2', '148819630205435904', 'test2', '2023-05-16 16:11:16');
...
CREATE TABLE `t_chat_room`  (
  `id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '房间号id',
  `name` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '房间名',
  `brief` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '简介',
  `type_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '房间类型id',
  `room_img_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '0' COMMENT '房间头像id',
  `creator_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '房间创建者id',
  `state` int NOT NULL DEFAULT 0 COMMENT '房间状态 0未开启,1开启',
  `create_time` timestamp NOT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '聊天室房间信息' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_chat_room
-- ----------------------------
INSERT INTO `t_chat_room` VALUES ('130716051154403328', '活力运动聊天室', '与运动爱好者一起分享，激励和成长！', '131033278420353024', '0', '102089129277259776', 1, '2023-03-27 16:58:55');
INSERT INTO `t_chat_room` VALUES ('130717592993136640', 'FitChat', '打造健康生活的社区，让运动成为习惯！', '131033278420353024', '0', '102089129277259776', 1, '2023-03-27 17:05:03');
INSERT INTO `t_chat_room` VALUES ('130718722326265856', '运动3频', '这是一个聊天频道', '131033278420353024', '0', '102089129277259776', 1, '2023-03-27 17:09:32');
INSERT INTO `t_chat_room` VALUES ('133644647577681920', 'SportConnect', '连接运动界的热情人士，畅谈体育话题！', '131033278420353024', '0', '102089129277259776', 1, '2023-04-04 18:57:10');
INSERT INTO `t_chat_room` VALUES ('133684442030931968', 'ActiveTalk', '让运动交流更简单，与全球运动爱好者共同追求健康！', '131033278420353024', '0', '102089129277259776', 1, '2023-04-04 21:34:15');
INSERT INTO `t_chat_room` VALUES ('134402340491886592', 'SportsForum', '与同好分享你的运动经历，探索更多运动乐趣！', '131033278420353024', '0', '102089129277259776', 1, '2023-04-06 21:06:55');
INSERT INTO `t_chat_room` VALUES ('134403836319105024', 'FitBuddy', '寻找理解你的运动伙伴，一起挑战健身目标！', '131033278420353024', '0', '102089129277259776', 1, '2023-04-06 21:12:52');
INSERT INTO `t_chat_room` VALUES ('134403853272481792', 'AthleteChat', '运动精英与热血爱好者的互动平台，探讨最新运动动态！', '131033278420353024', '0', '102089129277259776', 1, '2023-04-06 21:12:56');
INSERT INTO `t_chat_room` VALUES ('134403863502389248', 'SportsEnthusiast', '热爱运动者的在线聚集地，探索各类体育项目！', '131033278420353024', '0', '102089129277259776', 1, '2023-04-06 21:12:58');
INSERT INTO `t_chat_room` VALUES ('134403874311110656', 'ActiveCommunity', '为你打造的运动社区，分享、学习、成长！', '131033278420353024', '0', '102089129277259776', 1, '2023-04-06 21:13:01');
INSERT INTO `t_chat_room` VALUES ('134403885367296000', 'FitnessTalk', '与健身迷们畅所欲言，交流锻炼技巧和健康生活心得！', '131033278420353024', '0', '102089129277259776', 1, '2023-04-06 21:13:03');
INSERT INTO `t_chat_room` VALUES ('134403896922603520', '运动12频', 'let it go', '131033278420353024', '0', '102089129277259776', 1, '2023-04-06 21:13:06');
INSERT INTO `t_chat_room` VALUES ('134403912621883392', '运动13频', 'let it go', '131033278420353024', '0', '102089129277259776', 1, '2023-04-06 21:13:10');
INSERT INTO `t_chat_room` VALUES ('148815913959817216', 'MusicLovers', '音乐爱好者们的聚集地，分享你最喜欢的音乐类型和歌手！', '148815421703716864', '0', '102089129277259776', 1, '2023-05-16 15:40:38');
INSERT INTO `t_chat_room` VALUES ('148816698995113984', 'FilmFanatics', '电影迷们的交流空间，分享你最喜欢的电影和导演！', '148815421703716864', '0', '102089129277259776', 1, '2023-05-16 15:40:38');
INSERT INTO `t_chat_room` VALUES ('148816893258498048', 'Bookworms', '阅读爱好者们的社区，分享你最喜欢的书籍和作者！', '148815421703716864', '0', '102089129277259776', 1, '2023-05-16 15:40:38');
INSERT INTO `t_chat_room` VALUES ('148817228005900288', 'GameZone', '各种类型游戏爱好者的互动平台，分享你的游戏经验和心得！', '148815485507469312', '0', '102089129277259776', 1, '2023-05-16 15:40:38');
INSERT INTO `t_chat_room` VALUES ('148818215936458752', 'VirtualWorld', 'VR游戏爱好者的社交空间，一起探索虚拟现实的世界！', '148815485507469312', '0', '102089129277259776', 1, '2023-05-16 15:40:38');
INSERT INTO `t_chat_room` VALUES ('148818502222872576', 'StrategyRoom', '策略游戏玩家们的聚集地，分享你的游戏策略和战术！', '148815485507469312', '0', '102089129277259776', 1, '2023-05-16 15:40:38');
INSERT INTO `t_chat_room` VALUES ('148818819928817664', 'AcademicExchange', 'VR游戏爱好者的社交空间，一起探索虚拟现实的世界！', '148817459934134272', '0', '102089129277259776', 1, '2023-05-16 15:40:38');
INSERT INTO `t_chat_room` VALUES ('148818837653946368', 'ScienceTalks', '学术交流平台，分享你的研究课题和学术资源！', '148817459934134272', '0', '102089129277259776', 1, '2023-05-16 15:40:38');
INSERT INTO `t_chat_room` VALUES ('148818850765340672', 'LanguageLounge', '科学爱好者的互动空间，探讨最新科技和科学研究成果！', '148817459934134272', '0', '102089129277259776', 1, '2023-05-16 15:40:38');
INSERT INTO `t_chat_room` VALUES ('148819115132321792', 'CodeCrew', '程序员的聚集地，分享编程技巧和资源！', '148815485507469312', '0', '148817579601821696', 1, '2023-05-16 15:40:38');
INSERT INTO `t_chat_room` VALUES ('148819289191743488', 'CyberChat', '网络安全爱好者的社交空间，探讨最新网络安全和隐私保护问题！', '148815485507469312', '0', '148817579601821696', 1, '2023-05-16 15:40:38');
INSERT INTO `t_chat_room` VALUES ('148819303217496064', 'TechTalks', '科技爱好者的互动平台，分享你的科技观点和热点话题！', '148815485507469312', '0', '148817579601821696', 1, '2023-05-16 15:40:38');
INSERT INTO `t_chat_room` VALUES ('148819630205435904', 'FoodieFrenzy', '美食爱好者的交流社区，分享你的烹饪技巧和美食心得！', '148815485507469312', '0', '148817627060371456', 1, '2023-05-16 15:40:38');
INSERT INTO `t_chat_room` VALUES ('148819644520595456', 'KitchenChat', '烹饪爱好者们的社交空间，探讨最新厨房技巧和菜谱！', '148815485507469312', '0', '148817627060371456', 1, '2023-05-16 15:40:38');
INSERT INTO `t_chat_room` VALUES ('148819657053175808', 'HealthyEats', '健康饮食爱好者们的聚集地，分享健康饮食的知识和习惯！', '148815485507469312', '0', '148817627060371456', 1, '2023-05-16 15:40:38');

-- ----------------------------
-- Table structure for t_chat_room_type
-- ----------------------------
DROP TABLE IF EXISTS `t_chat_room_type`;
CREATE TABLE `t_chat_room_type`  (
  `id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '聊天室分区id',
  `name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '聊天室类型',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_chat_room_type
-- ----------------------------
INSERT INTO `t_chat_room_type` VALUES ('131033278420353024', '运动');
INSERT INTO `t_chat_room_type` VALUES ('148815421703716864', '兴趣爱好');
INSERT INTO `t_chat_room_type` VALUES ('148815485507469312', '游戏');
INSERT INTO `t_chat_room_type` VALUES ('148817459934134272', '学术讨论');
INSERT INTO `t_chat_room_type` VALUES ('148817579601821696', '技术');
INSERT INTO `t_chat_room_type` VALUES ('148817627060371456', '美食');
INSERT INTO `t_chat_room_type` VALUES ('148817665505361920', '健康生活');
INSERT INTO `t_chat_room_type` VALUES ('148817699269509120', '心灵成长');
INSERT INTO `t_chat_room_type` VALUES ('148817743674605568', '社交');
INSERT INTO `t_chat_room_type` VALUES ('148817784980111360', '语言交流');
INSERT INTO `t_chat_room_type` VALUES ('148817852541960192', '时事讨论');
INSERT INTO `t_chat_room_type` VALUES ('148817904861708288', '创意艺术');
INSERT INTO `t_chat_room_type` VALUES ('148817948365029376', '宠物');
INSERT INTO `t_chat_room_type` VALUES ('148817980925411328', '潮流时尚');
INSERT INTO `t_chat_room_type` VALUES ('148818033505206272', '旅行探索');
INSERT INTO `t_chat_room_type` VALUES ('148818070817734656', '孕婴护理');

-- ----------------------------
-- Table structure for t_head_portrait
-- ----------------------------
DROP TABLE IF EXISTS `t_head_portrait`;
CREATE TABLE `t_head_portrait`  (
  `id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `image` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '小头像',
  `image_big` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '清晰头像',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '头像表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_head_portrait
-- ----------------------------
INSERT INTO `t_head_portrait` VALUES ('0', 'https://tupian.qqw21.com/article/UploadPic/2021-8/20218112242037779.jpg', 'https://assets.leetcode.cn/aliyun-lc-upload/users/kun-hsu/avatar_1621649230.png');

-- ----------------------------
-- Table structure for t_msg_sign
-- ----------------------------
DROP TABLE IF EXISTS `t_msg_sign`;
CREATE TABLE `t_msg_sign`  (
  `room_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '房间id',
  `user_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '用户id',
  `sign_time` timestamp NOT NULL COMMENT '最新签收时间'
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '信息签收时间表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_msg_sign
-- ----------------------------
INSERT INTO `t_msg_sign` VALUES ('', '2', '2023-05-16 16:11:06');
INSERT INTO `t_msg_sign` VALUES ('', '1', '2023-05-16 16:11:07');
INSERT INTO `t_msg_sign` VALUES ('148819630205435904', '2', '2023-05-16 16:11:16');
INSERT INTO `t_msg_sign` VALUES ('148819630205435904', '1', '2023-05-16 16:11:16');
INSERT INTO `t_msg_sign` VALUES ('2', '1', '2023-05-16 16:11:23');
INSERT INTO `t_msg_sign` VALUES ('1', '2', '2023-05-16 16:11:23');
...
CREATE TABLE `t_permission`  (
  ...
  `name` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '权限名称',
...
CREATE TABLE `t_role`  (
  ...
  `name` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '角色名称',
...
CREATE TABLE `t_user`  (
  `id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '用户id(雪花算法)',
  `phone_number` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '手机号',
...
-- Records of t_user
-- ----------------------------
INSERT INTO `t_user` VALUES ('1', '1', '', '1', '2023-04-24 17:17:05', '2023-04-24 17:17:25');
INSERT INTO `t_user` VALUES ('2', '2', '', '2', '2023-04-24 17:17:05', '2023-04-24 17:17:08');
INSERT INTO `t_user` VALUES ('3', '3', '', '3', '2023-04-24 17:17:05', '2023-04-24 17:17:36');
INSERT INTO `t_user` VALUES ('4', '4', '', '4', '2023-04-24 17:17:46', '2023-04-24 17:17:50');
INSERT INTO `t_user` VALUES ('5', '5', '', '5', '2023-04-24 17:17:46', '2023-04-24 17:17:50');
...
CREATE TABLE `t_user_friend`  (
  `user1_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '用户id',
  `user2_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '用户好友id',
  `create_time` timestamp NOT NULL COMMENT '添加时间'
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '用户朋友表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_user_friend
-- ----------------------------
INSERT INTO `t_user_friend` VALUES ('1', '2', '2023-05-16 16:11:27');

-- ----------------------------
-- Table structure for t_user_friend_request
-- ----------------------------
DROP TABLE IF EXISTS `t_user_friend_request`;
CREATE TABLE `t_user_friend_request`  (
  `id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `send_user_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '请求用户id',
  `accept_user_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '接收用户id',
  `flag` int NOT NULL DEFAULT 0 COMMENT '处理情况（0 未处理，1同意，2拒绝，默认0）',
  `request_date_time` timestamp NOT NULL COMMENT '请求发送时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '好友申请表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_user_friend_request
-- ----------------------------
INSERT INTO `t_user_friend_request` VALUES ('148823480786223104', '2', '1', 1, '2023-05-16 16:11:23');
...
CREATE TABLE `t_user_info`  (
  ...
  `head_portrait_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '0' COMMENT '头像id',
  `sex` int NOT NULL DEFAULT 0 COMMENT '性别(默认0) 0：未知 1：男 2：女',
  ...
  `hobbies` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT '兴趣爱好',
  `region_id` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT '地区id'
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '用户信息表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_user_info
-- ----------------------------
INSERT INTO `t_user_info` VALUES ('1', '测试人员1', '0', 0, '让我来测试', '2023-04-24 17:18:31', ' 测试', '1002296');
INSERT INTO `t_user_info` VALUES ('2', '不一般的测试人员2', '0', 0, '让我来测试', '2023-04-24 17:19:13', ' 测试', '1002296');
INSERT INTO `t_user_info` VALUES ('3', '非常不一般的测试人员3', '0', 0, '我慢慢测试', '2023-04-24 17:21:40', ' 测试', '1002296');
INSERT INTO `t_user_info` VALUES ('4', '老实测试4', '0', 0, '我测试一点', '2023-04-24 17:21:49', ' 测试', '1002296');
INSERT INTO `t_user_info` VALUES ('5', '测5', '0', 0, '我来测试', '2023-04-24 17:22:01', ' 测试', '1002296');
...
CREATE TABLE `user_role`  (
  `id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `user_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '用户id',
  `role_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '\r\n角色id',
  PRIMARY KEY (`id`) USING BTREE
